...
TEST(ReferenceGeometry, get_quadrature_rule_1) {
	const auto fig = Figure::line;
	const auto fig_order = 1;
	const auto ref_geo = Reference_Geometry_Factory::make(fig, fig_order);
...
TEST(ReferenceGeometry, get_quadrature_rule_2) {
	const Figure fig = Figure::line;
	const ushort fig_order = 1;
	const auto ref_geo = Reference_Geometry_Factory::make(fig, fig_order);
...
TEST(ReferenceGeometry, get_quadrature_rule_3) {
	const Figure fig = Figure::triangle;
	const ushort fig_order = 1;
	const auto ref_geo = Reference_Geometry_Factory::make(fig, fig_order);
...
TEST(ReferenceGeometry, get_quadrature_rule_4) {
	const Figure fig = Figure::triangle;
	const ushort fig_order = 1;
	const auto ref_geo = Reference_Geometry_Factory::make(fig, fig_order);
...
TEST(ReferenceGeometry, get_quadrature_rule_5) {
	const Figure fig = Figure::quadrilateral;
	const ushort fig_order = 1;
	const auto ref_geo = Reference_Geometry_Factory::make(fig, fig_order);
...
TEST(ReferenceGeometry, get_quadrature_rule_6) {
	const Figure fig = Figure::quadrilateral;
	const ushort fig_order = 1;
	const auto ref_geo = Reference_Geometry_Factory::make(fig, fig_order);
