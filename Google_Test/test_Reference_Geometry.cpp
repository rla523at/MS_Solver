...
//	const auto& ref_geo = Reference_Geometry_Container::get_shared_ptr(fig, fig_order);
...
TEST(Reference_Geometry, face_reference_geometry_1)
{
	...
	const auto& line = Reference_Geometry_Container::get_shared_ptr(Figure::line, figure_order);
