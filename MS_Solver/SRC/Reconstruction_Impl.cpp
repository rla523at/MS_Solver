...
std::unique_ptr<Cell_Indicator> Indicator_Factory::make_hMLP_Indicator(const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
	return std::make_unique<MLP_Indicator>(grid, discrete_solution, criterion_equation_index);
}

std::unique_ptr<Cell_Indicator> Indicator_Factory::make_hMLP_BD_Indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
...
std::unique_ptr<Cell_Indicator> Indicator_Factory::make_hMLP_BD_Off_TypeII_indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
	auto shock_indicator = Shock_Indicator_Factory::make_unique(governing_equation_name, "Scaled_Difference", grid, discrete_solution);
...
std::unique_ptr<Cell_Indicator> Indicator_Factory::make_Improved_hMLP_BD1_Indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
	auto shock_indicator = Shock_Indicator_Factory::make_unique(governing_equation_name, "Scaled_Difference", grid, discrete_solution);
...
std::unique_ptr<Cell_Indicator> Indicator_Factory::make_Improved_hMLP_BD2_Indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
	auto shock_indicator = Shock_Indicator_Factory::make_unique(governing_equation_name, "Scaled_Difference", grid, discrete_solution);
...
std::unique_ptr<Cell_Indicator> Indicator_Factory::make_Improved_hMLP_BD3_Indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
	auto shock_indicator = Shock_Indicator_Factory::make_unique(governing_equation_name, "Scaled_Difference", grid, discrete_solution);
...
std::unique_ptr<Cell_Indicator> Indicator_Factory::make_Improved_hMLP_BD4_Indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
{
	auto shock_indicator = Shock_Indicator_Factory::make_unique(governing_equation_name, "Scaled_Difference", grid, discrete_solution);
