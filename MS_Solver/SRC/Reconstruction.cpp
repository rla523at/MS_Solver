...
//
//	const auto set_of_num_vertices = grid.cell_index_to_num_vertices_table();
//	
...
//
//					const auto limiting_value = this->MLP_u1_limiter_.limiter_function(discrete_solution,cell_index, this->stability_criterion_);
