...
template <typename Governing_Equation>
class Post_FVM_Solution_Data : public Post_Solution_Data_Base<Governing_Equation>
{
private:
	static_require(ms::is_governing_equation<Governing_Equation>, "it should be governing equation");
	...
	using Base_ = Post_Solution_Data_Base<Governing_Equation>;
...
template <typename Governing_Equation>
class Post_HOM_Solution_Data : public Post_Solution_Data_Base<Governing_Equation>
{
private:
	static_require(ms::is_governing_equation<Governing_Equation>, "it should be governing equation");
...
template <typename Governing_Equation>
class Post_Solution_Data<Governing_Equation, FVM> : public Post_FVM_Solution_Data<Governing_Equation>
{};


//template definition part
template <typename Governing_Equation>
void Post_Solution_Data_Base<Governing_Equation>::post_grid(const std::vector<Element<space_dimension_>>& cell_elements) {
	const auto num_cell = cell_elements.size();
	Post_Solution_Data_Base::num_post_points_.resize(num_cell);
	...
	for (uint i = 0; i < num_cell; ++i) {
		...
		Post_Solution_Data_Base::num_post_points_[i] = post_nodes.size();
...
template <typename Governing_Equation>
Text Post_Solution_Data_Base<Governing_Equation>::header_text(const Post_File_Type file_type) {
...
template <typename Governing_Equation>
void Post_FVM_Solution_Data<Governing_Equation>::post_solution(const std::vector<Euclidean_Vector<num_equation_>>& solutions, const std::string& comment) {
