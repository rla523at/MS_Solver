...
public://Command
	void record_cell_center_solution(void);
	void record_cell_center_variable(const std::string& name, const std::vector<double>& values);
...
public://Query
	...
	const std::vector<std::vector<double>>& get_set_of_cell_center_post_variable_values(void) const;
	const std::vector<std::string>& get_cell_center_post_variable_names(void) const;
	...
	ushort num_cell_center_post_variables(void) const;
...
private:	
	...
	std::vector<std::string> cell_center_post_variable_names_;
	std::vector<std::vector<double>> set_of_cell_center_post_variable_values_;
};
