...
template <typename Governing_Equation, typename Reconstruction_Method>
Boundaries_FVM_Linear<Governing_Equation, Reconstruction_Method>::Boundaries_FVM_Linear(Grid<space_dimension_>&& grid, const Reconstruction_Method& reconstruction_method)
