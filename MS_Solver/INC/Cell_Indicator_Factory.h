...
public://Query
    ...
    static std::unique_ptr<Cell_Indicator> make_hMLP_BD_11_1_2_Indicator(const std::string& governing_equation_name, const Grid& grid, Discrete_Solution_DG& discrete_solution, const ushort criterion_equation_index)
    {
        MLP_Indicator MLP_indicator(grid, discrete_solution, criterion_equation_index);
